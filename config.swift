...
typealias WVJBResponseCallback = (_ responseData:AnyObject)->Void

typealias WVJBHandler = (_ data:AnyObject,_ responseCallback:WVJBResponseCallback)->Void

typealias callBack = (_ data:String)->Void
